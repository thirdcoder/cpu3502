    ...
    for (let line of lines) {
      ...
      if (opcode.charAt(0) === '.') {
        ...
        if (opcode === 'equ') {
          ...
          ({addressing_mode, operand, operand_unresolved_at} = this.parse_operand(operand, line));
          ...
          ({addressing_mode, operand, operand_unresolved_at} = this.parse_operand(rest, line));
